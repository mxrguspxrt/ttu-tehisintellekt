...
def get_neighbors(proccessable_map, position):
    ...
    bottom_position = {
        "column_index": position["column_index"], "row_index": position["row_index"]+1}
    left_up_position = {
        "column_index": position["column_index"]-1, "row_index": position["row_index"]-1}
    right_up_position = {
        "column_index": position["column_index"]+1, "row_index": position["row_index"]-1}
...
def main():
    process_and_store_result("cave300x300-result-heuristic-lisa2", lava_map1_string)
    process_and_store_result("cave600x600-result-heuristic-lisa2", lava_map2_string)
    process_and_store_result("cave900x900-result-heuristic-lisa2", lava_map3_string)
