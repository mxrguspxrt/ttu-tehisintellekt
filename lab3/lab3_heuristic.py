...
def main():
    process_and_store_result("cave300x300-result-heuristic", lava_map1_string)
    process_and_store_result("cave600x600-result-heuristic", lava_map2_string)
    process_and_store_result("cave900x900-result-heuristic", lava_map3_string)
